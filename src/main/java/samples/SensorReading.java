...
public class SensorReading {
	...
	public SensorReading(String id, String revision, String sensorID, int locationID, long timestamp,
			double lowerBound, double upperBound, double percentZebra) {
		this.id = id;
	...
	String getKey() {
		final String result = getSensorID() + '-' 
				+ getLocationID() + '-' 
