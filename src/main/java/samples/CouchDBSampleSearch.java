...
//        String indexName = "travel-sample-index-stored";
        ...
        SearchQueryResult result = bucket.query(
            new SearchQuery(indexName, query).limit(10).clearHighlight());
    ...
    public static void unAnalyzedTermQuery(Bucket bucket, int fuzzinessLevel) {
        ...
        SearchQueryResult result = bucket.query(
            new SearchQuery(indexName, query).limit(50).clearHighlight());
    ...
    public static void main(String[] args) {
		...
		SensorReading reading1 = new SensorReading(UUID.randomUUID().toString(), "", "5", 1, (long) 1234, 0.0, 10.0, .5);
		SensorReading reading2 = new SensorReading(UUID.randomUUID().toString(), "", "5", 1, (long) 1235, 0.0, 20.0,.7);
		SensorReading reading3 = new SensorReading(UUID.randomUUID().toString(), "", "5", 1, (long) 1236, 1.0, 30.0,.4);
		SensorReading reading4 = new SensorReading(UUID.randomUUID().toString(), "", "5", 1, (long) 1237, 1.0, 40.0,.9);
