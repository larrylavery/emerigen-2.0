...
public interface Neighborhood {
	...
	/**
	 * Returns the list of the Agent's nearest neighbors. If the Agent is near an
	 * edge, then it's neighbors will include its neighbors on the wrap around
	 * border side.
	 * 
	...
	/**
	 * Returns the list of the agent's nearest neighbors up to a maximum number as
	 * specified by maxCount. If the Agent is near an edge, then it's neighbors may
	 * also include its neighbors on the wrap around border side.
	 * 
	 * @param agent The agent whose neighbors we are locating
	 * @return The list of neighbors
	 */
	...
	/**
	 * Moves an Agent to a location near the middle of the most concentrated area in
	 * the space.
	 * 
	 * @param Agent The Agent being moved
