...
public class HeartRateSensorEventListener extends EmerigenSensorEventListener {
	private static final Logger logger = Logger.getLogger(HeartRateSensorEventListener.class);
	...
	protected boolean significantChangeHasOccurred(SensorEvent previousSensorEvent,
		...
		if (heartRateDifference > HEARTRATE_DIFFERENCE_THRESHOLD) {
			logger.info("The difference (" + heartRateDifference + ") exceeds the threshold of "
