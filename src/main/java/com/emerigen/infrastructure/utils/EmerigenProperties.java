...
//	int eprCount = params.getInteger("epr_count");
    ...
    public void loadParams(String filename) {
        ...
        try {
            ...
            throw new RuntimeException("The Emerigen properties file not found. filename = " + filename + "..... " + e.getMessage());
        }
    }
    ...
    public void saveParamChangesAsXML(String filename) {
        try {
            ...
            throw new RuntimeException("Unable to save changes to Knowledge properties file. filename = " +
    ...
    public void setValue(String theKey, String theValue) {
        if ((theKey == null) || (theKey.length() == 0)) {
            throw new IllegalArgumentException("The key value must not be null or have a length of zero.");
        } else if ((theValue == null) || (theValue.length() == 0)) {
            throw new IllegalArgumentException("The value must not be null or have a length of zero.");
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmerigenProperties)) return false;
