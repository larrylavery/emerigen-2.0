...
public class NeighborhoodTest {
	...
	public final void givenNeighborhoodWithMultipleObjects_whenMoveToMostConcentratedArea_thenNewLaocationShouldHaveTheMostNeighbors() {
	    ...
	    logger.warn("NOT NEEDED AT THIS TIME: givenNeighborhoodWithMultipleObjects_whenMoveToMostConcentratedArea_thenNewLaocationShouldHaveTheMostNeighbors");
		return;
	}
	...
	public final void givenInputAgentIsNull_whenNeighborsRequested_thenIlegalArgumentException() {
		...
		//When neighbors requested
		final Throwable throwable = catchThrowable(() -> neighborhood.getNeighborsOfAgent(null));
	...
	public final void givenNullInputAgent_whenCountNeighborsRequested_thenIlegalArgumentException() {
		...
		//When neighbors requested
		final Throwable throwable = catchThrowable(() -> neighborhood.getNeighborsOfAgent(null, 1));
	...
	public final void givenNonPositiveMaxNeighborCount_whenCountNeighborsRequested_thenIlegalArgumentException() {
		...
		//When neighbors requested
		final Throwable throwable = catchThrowable(() -> neighborhood.getNeighborsOfAgent(new Agent(), -1));

		then(throwable).as("A non positive percentage should throw a IllegalArgumentException")
		.isInstanceOf(IllegalArgumentException.class);
	...
	public final void givenNonPositiveCount_whenCountNeighborsRequested_thenIlegalArgumentException() {
		...
		//When neighbors requested
		final Throwable throwable = catchThrowable(() -> neighborhood
				.getNeighborsOfAgent(new Agent(), -1));
	...
	public final void givenSizeIsZero_whenCreated_thenIllegalArgumentException() {
		...
		//When 
		final Throwable throwable = catchThrowable(() -> new NeighborhoodImpl(
				0));

		then(throwable).as("A neighborhood size zero should throw a IllegalArgumentException")
		.isInstanceOf(IllegalArgumentException.class);
	}
